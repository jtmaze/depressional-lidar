...
median_result_path = 'D:/depressional_lidar/data/bradford/out_data/well_wse_interpolations/interpolated_median_WSE_optimized_model_dummy_gauges.tif'
...
dem_im = ax.imshow(dem, cmap='Greys_r', origin='upper', extent=extent, alpha=1.0, vmin=35, vmax=50)
...
#ax.scatter(stream_gauges.geometry.x, stream_gauges.geometry.y, color='violet', marker='^', s=250, zorder=6, edgecolors='black')
