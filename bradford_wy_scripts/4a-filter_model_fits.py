...
wetland_pairs_path = f'D:/depressional_lidar/data/bradford/in_data/hydro_forcings_and_LAI/log_ref_pairs_{lai_buffer_dist}m_wetland_basins.csv'
models_path = data_dir + f'/model_info/model_estimates_wetlandLAI{lai_buffer_dist}m_domain_{data_set}.csv'
...
strong_pairs.to_csv(f'{data_dir}/strong_ols_models_wetland{lai_buffer_dist}m_domain_{data_set}.csv', index=False)
